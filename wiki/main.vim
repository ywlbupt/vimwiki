...
badd +0 ~/CPlusPlus/ctags58/main.h
badd +0 ~/vimwiki/wiki/index.wiki
args ~/CPlusPlus/ctags58/main.c
winpos 100 62
...
argglobal
nnoremap <buffer>   @=((foldclosed(line('.')) < 0) ? 'zC' : 'zO')
setlocal keymap=
setlocal noarabic
...
let s:l = 100 - ((33 * winheight(0) + 16) / 33)
...
normal! 0
lcd ~/
tabedit ~/CPlusPlus/ctags58/main.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
lcd ~/
tabedit ~/vimwiki/wiki/index.wiki
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
nmap <buffer> <silent> <C-CR> <Plug>VimwikiTabnewLink
